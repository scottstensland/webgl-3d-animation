...
function inner_play_tune_jam(once_playback_starts_callback, given_mode, stop_callback, flag_loop) {
    ...
    // var chosen_audio_file = "Elephant_sounds_rgUFu_hVhlk_roar_mono.wav";
    ...
    given_node.onaudioprocess = (function () {
        ...
        return function (event) {       
            ...
            if (allow_synth) {
                ...
                var phi = 0, dphi = 2.0 * Math.PI * given_node.sample_freq / 
                                                    given_node.sample_rate;

                for (var curr_sample = 0; curr_sample < given_node.BUFF_SIZE; 
                        curr_sample++, phi += dphi) {
